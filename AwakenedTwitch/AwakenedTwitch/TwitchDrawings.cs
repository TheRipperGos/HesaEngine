...
namespace AwakenedTwitch
{
    public class TwitchDrawings
    {
        ...
        private static void Ondrawing(EventArgs args)
        {
            ...
            {
                Drawing.DrawCircle(ObjectManager.Player.Position,W.Range, Color.Magenta);
            }
            ...
            Vector2 screenPosition = Drawing.WorldToScreen(Twitch.Position);
